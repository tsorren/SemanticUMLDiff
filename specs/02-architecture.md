...
- **Impacted Classes:** Classes with no internal code modifications but whose relations were added, removed, or modified, or are part of the context expansion, are marked as **`<<impacted>>`** (rendered with a gray/transparent background, gray font/border, and dashed border `#6C757D`).
